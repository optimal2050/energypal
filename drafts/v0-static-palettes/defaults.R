...
.onLoad <- function(libname, pkgname) {
  ...
  default_opts <- list()
  default_opts[[.energypal_option_names$default_palette]] <- "iea_primary"
...
set_default_energy_palette <- function(palette, validate = TRUE) {
  ...
  previous <- getOption(.energypal_option_names$default_palette, "iea_primary")
...
get_default_energy_palette <- function() {
  return(getOption(.energypal_option_names$default_palette, "iea_primary"))
}
...
reset_default_energy_palette <- function() {
  previous <- getOption(.energypal_option_names$default_palette, "iea_primary")
  options(setNames(list("iea_primary"), .energypal_option_names$default_palette))
  message("Default energy palette reset to: iea_primary")
  invisible(previous)
}
