...
![](reference/figures/README-gallery-1.png)
...
![](reference/figures/README-ramps-1.png)
...
shows the working, which is what you want when a label is not colouring
as expected:
...
resolves the labels in your data — no preprocessing, no manual colour
vector.
...
![](reference/figures/README-mix-1.png)
...
one carries a note saying so, which
[`energypal_orders()`](https://optimal2050.github.io/energypal/reference/energypal_orders.md)
prints and which travels with the data as a column attribute.
...
![](reference/figures/README-resource-1.png)

No `breaks` argument:
[`scale_fill_energy_b()`](https://optimal2050.github.io/energypal/reference/scale_energy.md)
takes them from the palette, which declares 2.5–17 m/s in half-metre
steps. Speeds above the top break saturate into the last bin — the
Southern Ocean — which is what a declared-breaks scale is for.
[`scale_fill_energy_c()`](https://optimal2050.github.io/energypal/reference/scale_energy.md)
gives a smooth ramp over the same stops instead.
...
![](reference/figures/README-variants-1.png)
...
[`vignette("palettes")`](https://optimal2050.github.io/energypal/articles/palettes.md)
